_base_ = [
    ...
    '/home/alper/Desktop/Works/Tez/mmdetection3d/configs/_base_/models/point_rcnn.py',
...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(car=5, pedestrian=5, bicycle=5)),
    sample_groups=dict(car=20, pedestrian=15, bicycle=15),
    classes=class_names,
    points_loader=dict(
