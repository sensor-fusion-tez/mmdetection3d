...
class CenterHeadKITTI(BaseModule):
    ...
    def __init__(self,
        ...
        super(CenterHeadKITTI, self).__init__(init_cfg=init_cfg, **kwargs)
    ...
    def get_targets_single(self,
        ...
        gt_annotation_num = len(self.train_cfg['code_weights']) # KITTI adaptation
        ...
        for idx, task_head in enumerate(self.task_heads):
            ...
            # anno_box = gt_bboxes_3d.new_zeros((max_objs, 10),              # KITTI adaptation 
            #                                   dtype=torch.float32)
            anno_box = gt_bboxes_3d.new_zeros((max_objs, gt_annotation_num), # KITTI adaptation
                                              dtype=torch.float32)
            ...
            for k in range(num_objs):
                ...
                if width > 0 and length > 0:
                    ...
                    # vx, vy = task_boxes[idx][k][7:] # KITTI adaptation
